<div class="footer">
    <div class="footer-container">
        ...
        <div class="newsletter">
            <h4>Newsletter</h4>
            <p>Join thousands of other people sub&shy;scribe to our news</p>
            <form action="#">
                <input type="email" placeholder="insert email" required><input type="submit" value="SUBMIT">
            </form>
...
<div class="copyright">
    <div class="copyright-container">
        ...
        <div class="footer-social">
            ...
            <a href="#" class="fa fa-tumblr" aria-hidden="true"></a>
